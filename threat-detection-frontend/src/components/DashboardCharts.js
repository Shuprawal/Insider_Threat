...
//   const lineHasData = Array.isArray(alertPoints) && alertPoints.length > 0;
//
...
//
//   /* ---------- PIE ---------- */
//   const pieHasData = Array.isArray(pieData?.values) && pieData.values.some(v => Number(v) > 0);
//
...
//
//   /* ---------- BAR ---------- */
//   const barHasData = Array.isArray(barData?.values) && barData.values.some(v => Number(v) > 0);
//
